<?php if (empty($reservation_header)) { ?>
<div class="wpc-admin-header">
    <div class="wpc-admin-header-logo">
        <?php 
            $wpc_main_logo = \Wpcafe::assets_url() . 'images/logo.png';
        ?>
        <div class="wpc-logo-wrap">
            <img src="<?php echo esc_url($wpc_main_logo); ?>" alt="" />
            <span class="wpc-version">
                <?php echo esc_html__('v','wpcafe') . \Wpcafe::version(); ?>
            </span>
        </div>
            <?php if($_GET['page'] == 'cafe_settings'){ ?>
                <h1 class="wpc-settings-title wpc-header-title"><?php echo esc_html__('Settings', 'wpcafe'); ?></h1>
            <?php } ?>
            <?php if($_GET['page'] == 'wpc_shortcode'){ ?>
                <h1 class="wpc-settings-title wpc-header-title"><?php echo esc_html__('Shortcodes', 'wpcafe'); ?></h1>
            <?php } ?>
            <?php if(class_exists('Wpcafe_Pro') && ($_GET['page'] == 'wpc-license')) {?>
                <h1 class="wpc-settings-title wpc-header-title"><?php echo esc_html__('License', 'wpcafe'); ?></h1>  
            <?php } ?>
    </div>
    <?php if(($_GET['page'] == 'cafe_menu') || ($_GET['page'] == 'wpc_tools')) { ?>
    <div class="wpc-admin-menu-wrap">
        <ul>
            <li><a href="<?php echo esc_url(admin_url().'admin.php?page=cafe_settings')?>"><?php echo esc_html__('Settings', 'wpcafe' ) ?></a></li>
            <li><a href="<?php echo esc_url(admin_url().'edit.php?post_type=wpc_reservation')?>"><?php echo esc_html__('Reservation List', 'wpcafe' ) ?></a></li>
            <?php if(class_exists('Wpcafe_Pro')) :?>
                <li><a href="<?php echo esc_url(admin_url().'admin.php?page=wpc_product_addons')?>"><?php echo esc_html__('Product Addons', 'wpcafe' ) ?></a></li>
            <?php endif; ?>
            <li><a href="<?php echo esc_url(admin_url().'admin.php?page=wpc_tools')?>"><?php echo esc_html__('Add-ons', 'wpcafe' ) ?></a></li>
            <li><a href="<?php echo esc_url(admin_url().'admin.php?page=wpc_shortcode')?>"><?php echo esc_html__('Shortcodes', 'wpcafe' ) ?></a></li>
            <?php if(class_exists('Wpcafe_Pro')) :?>
                <li><a href="<?php echo esc_url(admin_url().'admin.php?page=wpc-license')?>"><?php echo esc_html__('License', 'wpcafe' ) ?></a></li>
            <?php endif; ?>
        </ul>
    </div>
    <?php } ?>
    <div class="wpc-header-btn-wrap">
            ...
            <div class="wpc-admin-btn-wrap">
                ...
                <div class="dropdown">
                    <div class="list-item">
                        ...
                        <span><?php echo esc_html__('Need Help?', 'wpcafe' ) ?></span>
                        </a>
                        <a href="<?php echo esc_url( "https://support.themewinter.com/docs/plugins/wp-cafe/" )?>" target="_blank">
                            <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span><?php echo esc_html__('Documentation', 'wpcafe' ) ?></span>

                        </a>
                        <a href="<?php echo esc_url("https://themewinter.com/wpcafe-roadmaps/#ideas")?>" target="_blank">
                            <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span><?php echo esc_html__('Feature Request', 'wpcafe' ) ?></span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <?php if($_GET['page'] == 'cafe_settings'){ ?>
        <div class="wpc-submit-wrap-header">
