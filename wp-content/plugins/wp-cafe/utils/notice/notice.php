...
class Notice{
    ...
    public function  generate_html() {
        ...
        <div 
            ...
            expired_time="<?php echo Wpc_Utilities::wpc_render($this->expired_time); ?>"
            dismissible="<?php echo Wpc_Utilities::wpc_render($this->dismissible); ?>"
        >
            ...
            <div class="notice-right-container <?php echo (empty($this->logo) ? 'notice-container-full-width' : ''); ?>">
                ...
                <?php else:?>
                    <?php echo Wpc_Utilities::wpc_render($this->html); ?>
                <?php endif;?>
